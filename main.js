        ...
        .then(function weather(data){
            ...
            fetch("https://meta-weather.vercel.app/api/location/"+woeId+"/")
                ...
                .then(function weather(data){
                    ...
                    console.log(cityTitle, country, date, generalWeather, temp, humidity);
                    ...
                    tempElement.textContent = "Temperature: " + Math.floor(temp)

                    var windElement = document.querySelector(".wind-info");
                    windElement.textContent = "wind speed " + Math.floor(wind);

                    var humidityElement = document.querySelector(".humidity");
                    humidityElement.textContent = Math.floor(humidity)
                })
